...
function row(over: Partial<TradeProposal> = {}): TradeProposal {
    return {
        ...
        strategyId: 'overnight', setupId: 'eod-continuation', holdingHorizon: 'next-session', exitPolicyId: 'bracket+deadline', exitDeadline: T0, deadlineClosedAt: null, detectorVersion: null,
