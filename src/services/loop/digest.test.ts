...
function proposal(overrides: Partial<TradeProposal> = {}): TradeProposal {
    return {
        ...
        orderIds: [1, 2, 3], orderPermIds: null, plannedQuantity: null, model: null, strategyFingerprint: null, strategyId: null, setupId: null, holdingHorizon: null, exitPolicyId: null, exitDeadline: null, deadlineClosedAt: null, deadlineAttemptedAt: null, deadlineAttempts: 0, snapshotTs: null, detectorVersion: null, costToTargetPct: null, laneRank: null, rankerVersion: null, regime: null, note: null, executedAt: T0, entryFillPrice: 100.05, entryFilledAt: T0 + 60_000,
