...
function row(over: Partial<TradeProposal> = {}): TradeProposal {
    return {
        ...
        strategyId: 'intraday', setupId: null, holdingHorizon: 'same-session', exitPolicyId: 'take-x', exitDeadline: null, deadlineClosedAt: null, deadlineAttemptedAt: null, deadlineAttempts: 0, snapshotTs: null, detectorVersion: null, costToTargetPct: null, laneRank: null, rankerVersion: null, regime: null, note: null,
