...
function row(overrides: Partial<TradeProposal> = {}): TradeProposal {
    return {
        ...
        plannedQuantity: null, model: null, strategyFingerprint: null, strategyId: null, setupId: null, holdingHorizon: null, exitPolicyId: null, exitDeadline: null, deadlineClosedAt: null, detectorVersion: null, costToTargetPct: null, regime: null, note: null, executedAt: 1, entryFillPrice: null, entryFilledAt: null,
