...
const order = (o: Partial<BrokerOrderSnap>): BrokerOrderSnap =>
    ({ orderId: 1, symbol: 'NVDA', orderRef: null, account: ACCT, quantity: null, action: null, orderType: null, auxPrice: null, lmtPrice: null, ocaGroup: null, tif: null, status: null, ocaType: null, ...o });
